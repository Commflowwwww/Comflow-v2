...
function moveStep(n) {
    ...
    // ===== LÓGICA DE ENVIO FINAL (PASSO 3) — COM SUPABASE =====
    if (n === 1 && currentStep === 3) {
        ...
        // Envia ao Supabase e, após resposta, exibe tela de sucesso
        enviarFormulario().then(sucesso => {
            if (sucesso) {
...
window.addEventListener('DOMContentLoaded', function() {
    ...
    // Inicializa o DropZone (apenas na página principal)
